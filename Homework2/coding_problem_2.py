...
# open parsedDates.txt
# iterate through dates in correct format list and split info into parts.
# ignores any month that isn't a key from the dictionary(wrong format),cant be called.
# delete the ',' by replacing it with a blank space.
# make sure date is before the current date
# reformat and write into parsedDates.txt
